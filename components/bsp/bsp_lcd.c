...
esp_err_t bsp_lcd_init(void)
{
    ...
    ESP_ERROR_CHECK(esp_lcd_panel_set_gap(lcd_panel, 20, 0));
    ...
    //     vTaskDelay(pdMS_TO_TICKS(2000));
    // }
    lcd_draw_touch_point(lcd_panel, 30, 30, COLOR_RED);
    lcd_draw_touch_point(lcd_panel, LCD_WIDTH-30, LCD_HEIGHT-30, COLOR_RED);
