...
{
    rmt_config_t config = RMT_DEFAULT_CONFIG_TX(GPIO_RMT_SIG, RMT_CHANNEL_0);
    ...
    led_strip_config_t strip_config = LED_STRIP_DEFAULT_CONFIG(RGB_LED_NUM, (led_strip_dev_t)config.channel);
