...
void ui_audio_start(void)
{
    ...
    lv_obj_align(btn_play_pause, LV_ALIGN_CENTER, 0, 60);
    ...
    lv_obj_set_style_text_font(lab_title, &lv_font_montserrat_30, LV_STATE_DEFAULT);
    lv_obj_align(lab_title, LV_ALIGN_TOP_MID, 0, 30);
    ...
    lv_obj_set_style_text_font(music_list, &lv_font_montserrat_12, LV_STATE_DEFAULT);
